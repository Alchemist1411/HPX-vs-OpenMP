...
std::size_t inner_loop(const matrix& M1, const matrix& M2, std::size_t row, std::size_t col, std::size_t n)
{
...
time_result sequential(const matrix& m1, const matrix& m2, const std::size_t n)
{
    matrix result(n, std::vector<std::size_t>(n));
...
time_result parallel(const matrix& m1, const matrix& m2, const std::size_t n)
{
    matrix result(n, std::vector<std::size_t>(n));
...
int main(int argc, char* argv[])
{
    ...
    desc_commandline.add_options()("n", value<std::size_t>()->default_value(500), "Matrix dimension");
